...
def _dissect_headers(obj, s, crlfcrlf):
    ...
    '''
    first_line, headers, body = _parse_headers(s, crlfcrlf)
...
class HTTPResponse(Packet):
    ...
    def do_dissect(self, s):
        ''' From the HTTP packet string, populate the scapy object '''
        first_line, body = _dissect_headers(self, s, b"\x0d\x0a\x0d\x0a")
